...
# 改回原 DB（保留订单历史）；删除新空库
sed -i 's|tradesv3_CK_Strategy_Surge\.sqlite|tradesv3_CK_Strategy.sqlite|g' docker-compose.yml
rm -f user_data/tradesv3_CK_Strategy_Surge.sqlite
echo '=== 修改后 ==='
grep -n "db-url\|strategy" docker-compose.yml
echo '=== 重启容器 ==='
...
import sqlite3
c = sqlite3.connect('/freqtrade/user_data/tradesv3_CK_Strategy.sqlite')
