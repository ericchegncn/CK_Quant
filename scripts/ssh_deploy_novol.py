#!/usr/bin/env python
"""部署 CK_Strategy_Surge_NoVol 到实盘（保留原 DB，只改策略名）"""
import os, sys
import paramiko
...
LOCAL = r"D:\Eric Cheng\Documents\CK_Quant\user_data\strategies\CK_Strategy_Surge_NoVol.py"
REMOTE = "/root/ft_userdata/user_data/strategies/CK_Strategy_Surge_NoVol.py"
...
sed -i 's/--strategy CK_Strategy_Surge$/--strategy CK_Strategy_Surge_NoVol/' docker-compose.yml
echo '=== 修改后 ==='
grep -n "strategy\|db-url" docker-compose.yml
echo '=== 重启 ==='
